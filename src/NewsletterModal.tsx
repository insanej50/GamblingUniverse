...
const LEADS_URL = 'https://script.google.com/macros/s/AKfycbx5yY_MHLSzzHjGjMG5VrVYIEcbv4Z_DTvAVxUNyyxNF3hXLNV-nfh-cI6XWSP30Vwj/exec';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch(LEADS_URL, {
        ...
        body: JSON.stringify({ name, email, phone, page: pageKey }),
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700, textTransform: 'uppercase', cursor: saving ? 'wait' : 'pointer',
              ...
              {saveError && (
                <p style={{ color: '#f87171', fontSize: '14px', margin: 0 }}>Could not save. Try again.</p>
              )}
              <button
