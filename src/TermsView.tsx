...
export const TermsView = () => {
  return (
    <section id="terms" className="listing-section" style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', color: 'rgba(255, 255, 255, 0.8)', fontFamily: 'var(--font-body)' }}>
      ...
      <div className="terms-content" style={{ display: 'flex', flexDirection: 'column', gap: '32px', fontSize: '17px', lineHeight: '1.7' }}>
        ...
        <div>
          <h3 style={{ color: 'white', fontSize: '18px', marginBottom: '12px', fontFamily: 'var(--font-display)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>3. Age and Legal Compliance</h3>
          <p>
        ...
        <div>
          <h3 style={{ color: 'white', fontSize: '18px', marginBottom: '12px', fontFamily: 'var(--font-display)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>4. Affiliate Disclosure</h3>
          <p>
        ...
        <div>
          <h3 style={{ color: 'white', fontSize: '18px', marginBottom: '12px', fontFamily: 'var(--font-display)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>7. Responsible Gambling</h3>
          <p>
